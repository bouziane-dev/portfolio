...
const Footer = () => {
  return (
    <footer className='mb-6 mt-20 grid grid-cols-2 justify-items-center gap-x-3 gap-y-6 md:flex md:justify-around'>
      {/* Animated text */}
      <p className='animate-gradient cursor-pointer bg-gradient-to-r from-[#13ADC7] via-[#6978D1] to-[#945DD6] bg-200% bg-clip-text text-sm font-medium text-transparent drop-shadow-[0_0_8px_rgba(148,93,214,0.6)]'>
